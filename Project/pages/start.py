        ...
        return  SafeArea(
                        content= Card(content=Column(
                            controls=[
                                ...
                                Container(content=Text('Automatic Bill Generator', scale= 1.8), padding= padding.only(top=10, bottom=30)),
                                FilledTonalButton(" Continue ", icon=icons.ARROW_CIRCLE_RIGHT_OUTLINED,on_click= lambda _: self.page.go("/home")),
